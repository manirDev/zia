...
function initMonacoEditor(containerId, initialContent = '') {
    require.config({ paths: { 'vs': '../build_wasm/node_modules/monaco-editor/min/vs' }});
    ...
    require(['vs/editor/editor.main'], function() {
        ...
        monaco.languages.setMonarchTokensProvider('zia', {
            ...
            keywords: [
                'var', 'fonction', 'si', 'sinon', 'pour', 'tantque',
                'retourne', 'affiche', 'vrai', 'faux', 'nul'
            ],
...
function createNewFile() {
    const fileName = prompt('Enter file name (must end with .zia):', 'new_file.zia');
    if (!fileName) return;
